function yestoall_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
yestoall_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				yestoall_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
yestoall_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
yestoall_xmlhttpRequester.prototype.setupRequestEvent =
